...
from models import Table, MenuItem, Category, Order, OrderItem, Staff

def seed_database():
    # 1. HARD RESET: Drop all tables to apply schema changes
    SQLModel.metadata.drop_all(engine)
    
    # 2. Recreate tables with new columns
